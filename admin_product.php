        ...
        <form action="" method="POST" enctype="multipart/form-data">
            ...
            <div class="flex">
                ...
                <div class="inputBox">
                    ...
                    <input type="file" class="box" accept="image/jpeg, image/jpg, image/png" name="image">
                </div>


            </div>

            <textarea name="details" class="box" placeholder="enter product details" rows="10" cols="30"></textarea>
